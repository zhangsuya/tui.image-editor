...
import FreeCircleSelecte from '@/component/freeCircleSelecte';
import FreePaintSelecte from '@/component/FreePaintSelecte';
...
import FreeCircleSelecteMode from '@/drawingMode/freeCircleSelecte';
import FreePaintMode from '@/drawingMode/FreePaintSelecte';
...
class Graphics {
  ...
  _createDrawingModeInstances() {
    ...
    this._register(this._drawingModeMap, new FreeCircleSelecteMode());
    this._register(this._drawingModeMap, new FreePaintMode());
  ...
  _createComponents() {
    ...
    this._register(this._componentMap, new FreeCircleSelecte(this));
    this._register(this._componentMap, new FreePaintSelecte(this));
